...
**BACnet/SC (Secure Connect)** (Professional)
- ASHRAE Addendum BJ (Annex YY) compliant — TLS 1.3 with mutual X.509 certificate authentication
- Direct Connect listener accepts peer-to-peer WSS connections (up to 10 concurrent peers)
- SC node client connects to BACnet/SC hubs with auto-reconnect and heartbeat keepalive
- All 13 BVLC message types: Connect, Encapsulated-NPDU, Heartbeat, Address-Resolution, Advertisement, and more
...
BACsync&trade; is a trademark of Humber Horizons Limited.
